...
<%
    JSONArray array = new JSONArray(session.getAttribute(NamedContext.RESTAURANT).toString());
    Integer restaurantNum = array.length();
%>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    restaurants = <%=session.getAttribute(NamedContext.RESTAURANT)%>;
    restaurantType = <%=session.getAttribute(NamedContext.RESTAURANTTYPE)%>;
    addresses = <%=session.getAttribute(NamedContext.ADDRESS)%>;
</script>
<body onload=loadRestaurantCharts()>
...
<form class="am-form">
    <fieldset>
        ...
        <div class="am-form-group">
            <label for="num">餐厅总数</label>
            <span id="num"><%=restaurantNum%></span>
        </div>
        ...
        <hr data-am-widget="divider" style="" class="am-divider am-divider-default" />
        <div class="am-form-group">
            <label for="type">餐厅类型占比图</label>
            <div id="type" style="width: 600px;height:400px;"></div>
        </div>
        <hr data-am-widget="divider" style="" class="am-divider am-divider-default" />
        <div class="am-form-group">
            <label for="address">餐厅分布</label>
